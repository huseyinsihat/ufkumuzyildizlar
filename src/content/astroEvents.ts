...
export const ASTRO_EVENTS: readonly AstroEvent[] = [
  ...
  },
  {
    ...
    facts: [
      ...
      'Çekimle ısınır: cisim sıkışır, gevşer, ısınır.',
    ],
    hostBodyId: 'jupiter',
  ...
  },
  {
    ...
    facts: [
      ...
      'Çizgiler aynı noktadan geliyor gibi görünür; buna yağmurun geldiği nokta denir.',
  ...
  },
  {
    ...
    facts: [
      ...
      'Parlama, kısa süre bir gökadadaki tüm yıldızları geçebilir.',
    ],
    hostBodyId: null,
    relatedBodyIds: [],
    durationMs: 16_000,
